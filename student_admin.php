    ...
    <div class="main--content">
        <div class="header--wrapper">
            <div class="header--title">
                ...
                <a href="add_student.php" class="btn-primary"><i class="uil uil-plus"></i>Add Student</a>
                </div>
                                    ...
                                    if($res==TRUE)
                                    {
                                        ...
                                        if($count>0)
                                        {
                                            ...
                                            while($rows= mysqli_fetch_assoc($res))
                                            {
                                                ...
                                                $course_fee=$rows['course_fee'];
                                                $pending_fee=$rows['pending_fee'];
                                                ...
                                                ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?php echo SITEURL; ?>view_student.php?id=<?php echo $id; ?>"><i class="uil uil-eye"></i></a>
                                                        </td>
                                                        <td>
                                                            <a href="<?php echo SITEURL; ?>update_student.php?id=<?php echo $id; ?>"><i class="uil uil-edit"></i> </a>
                                                            <a href="<?php echo SITEURL; ?>delete_student.php?id=<?php echo $id; ?>"><i class="uil uil-trash-alt"></i> </a>
                                                        </td>
                                                    </tr>
